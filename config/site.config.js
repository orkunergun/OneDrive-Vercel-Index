...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || '68orkun@z28qh.onmicrosoft.com',
  ...
  email: 'mailto:orkun68100@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/orkunergun',
    },
  ],
